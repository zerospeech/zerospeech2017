// $Header: /u/drspeech/repos/quicknet2/QN_SRIfeat.h,v 1.5 2004/09/07 23:30:01 davidj Exp $
// -*- C++ -*-

#ifndef QN_SRIfeat_h_INCLUDED
#define QN_SRIfeat_h_INCLUDED

// This file contains routines for handling SRI feature files.
// (this code is based on QN_Strut.h)
//
...
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
// QN_InFtrStream_SRI - access an SRI feature file for input
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////

class QN_InFtrStream_SRI : public QN_InFtrStream
{
public:
    // Constructor
    ...
    QN_InFtrStream_SRI(int a_debug, const char* a_dbgname,
			 FILE* a_file);
    ~QN_InFtrStream_SRI();
...
// This is based on QN_OutFtrStream_HTK
class QN_OutFtrStream_SRI : public QN_OutFtrStream
{
public:
    // Constructor
    // "a_debug" controls the level of status message output.
    ...
    QN_OutFtrStream_SRI(int a_debug, const char* a_dbgname,
...
inline size_t
QN_OutFtrStream_SRI::num_ftrs()
{
    return n_ftrs;
}

#endif // #ifndef QN_SRIfeat_h_INCLUDED
