const char* QN_fltvec_bmul3_rcsid = "$Header: /u/drspeech/repos/quicknet2/QN_fltvec_bmul3.cc,v 1.2 2004/04/20 00:57:13 davidj Exp $";
...
**    /n/burrito/da/bilmes/phipac/mm_gen/mm_gen -cb 2 4 10 -cb 26 13 5 -file /n/marmite/db/davidj/tmp/dj -prec single -routine_name _php_mulacc_mfmf_mf -alpha 1 -beta 1 
**
** Generated on: Sunday June 25 1995, 13:23:45 PDT
...
#define mul_mf1x4mf4x1_mf1x1(c00,A0,B,Bstride) \
{ \
   register float _b0; \
   register float _a; \
   \
...
#define mul_mf1x4mf4x2_mf1x2(c00,c01,A0,B,Bstride) \
{ \
   register float _b0,_b1; \
   register float _a; \
   \
...
#define mul_mf1x4mf4x4_mf1x4(c00,c01,c02,c03,A0,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3; \
   register float _a; \
   \
...
#define mul_mf1x4mf4x8_mf1x8(c00,c01,c02,c03,c04,c05,c06,c07,A0,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3,_b4,_b5,_b6,_b7; \
   register float _a; \
   \
...
#define mul_mf1x4mf4x10_mf1x10(c00,c01,c02,c03,c04,c05,c06,c07,c08,c09,A0,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3,_b4,_b5,_b6,_b7,_b8,_b9; \
   register float _a; \
   \
...
#define mul_mf2x1mf1x1_mf2x1(c00,c10,A0,A1,B,Bstride) \
{ \
   register float _b0; \
   register float _a; \
   \
...
#define mul_mf2x2mf2x1_mf2x1(c00,c10,A0,A1,B,Bstride) \
{ \
   register float _b0; \
   register float _a; \
   \
...
#define mul_mf2x4mf4x1_mf2x1(c00,c10,A0,A1,B,Bstride) \
{ \
   register float _b0; \
   register float _a; \
   \
...
#define mul_mf2x1mf1x2_mf2x2(c00,c01,c10,c11,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1; \
   register float _a; \
   \
...
#define mul_mf2x2mf2x2_mf2x2(c00,c01,c10,c11,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1; \
   register float _a; \
   \
...
#define mul_mf2x4mf4x2_mf2x2(c00,c01,c10,c11,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1; \
   register float _a; \
   \
...
#define mul_mf2x1mf1x4_mf2x4(c00,c01,c02,c03,c10,c11,c12,c13,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3; \
   register float _a; \
   \
...
#define mul_mf2x2mf2x4_mf2x4(c00,c01,c02,c03,c10,c11,c12,c13,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3; \
   register float _a; \
   \
...
#define mul_mf2x4mf4x4_mf2x4(c00,c01,c02,c03,c10,c11,c12,c13,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3; \
   register float _a; \
   \
...
#define mul_mf2x1mf1x8_mf2x8(c00,c01,c02,c03,c04,c05,c06,c07,c10,c11,c12,c13,c14,c15,c16,c17,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3,_b4,_b5,_b6,_b7; \
   register float _a; \
   \
...
#define mul_mf2x2mf2x8_mf2x8(c00,c01,c02,c03,c04,c05,c06,c07,c10,c11,c12,c13,c14,c15,c16,c17,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3,_b4,_b5,_b6,_b7; \
   register float _a; \
   \
...
#define mul_mf2x4mf4x8_mf2x8(c00,c01,c02,c03,c04,c05,c06,c07,c10,c11,c12,c13,c14,c15,c16,c17,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3,_b4,_b5,_b6,_b7; \
   register float _a; \
   \
...
#define mul_mf2x1mf1x10_mf2x10(c00,c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13,c14,c15,c16,c17,c18,c19,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3,_b4,_b5,_b6,_b7,_b8,_b9; \
   register float _a; \
   \
...
#define mul_mf2x2mf2x10_mf2x10(c00,c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13,c14,c15,c16,c17,c18,c19,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3,_b4,_b5,_b6,_b7,_b8,_b9; \
   register float _a; \
   \
...
#define mul_mf2x4mf4x10_mf2x10(c00,c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13,c14,c15,c16,c17,c18,c19,A0,A1,B,Bstride) \
{ \
   register float _b0,_b1,_b2,_b3,_b4,_b5,_b6,_b7,_b8,_b9; \
   register float _a; \
   \
...
void
_php_mulacc_mfmf_mf_l1_arb_k(int K, const float *const A, const float *const B, float *const C, const int Astride, const int Bstride, const int Cstride)
{
   const float *a0,*b0;
   float *c0;
   ...
   for (c0=C,a0=A; c0!= c0_endp; c0+=C_sbs_stride,a0+=A_sbs_stride) {
      ...
      for (b0=B,cp0=c0; cp0!=cp0_endp; b0+=10,cp0+=10) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4,ap0_1+=4) {
            mul_mf2x4mf4x10_mf2x10(c00,c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13,c14,c15,c16,c17,c18,c19,ap0_0,ap0_1,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
            mul_mf2x2mf2x10_mf2x10(c00,c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13,c14,c15,c16,c17,c18,c19,ap0_0,ap0_1,bp0,Bstride);
            ap0_0+=2;ap0_1+=2;
         }
         if (k_marg_el & 0x1) {
            mul_mf2x1mf1x10_mf2x10(c00,c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13,c14,c15,c16,c17,c18,c19,ap0_0,ap0_1,bp0,Bstride);
         }
...
void
_php_mulacc_mfmf_mf_l1_arb_all(const int M, const int K, const int N, const float *const A, const float *const B, float *const C, const int Astride, const int Bstride, const int Cstride)
{
   const float *a0,*b0;
   float *c0;
   const float *ap0_0,*ap0_1;
   ...
   for (c0=C,a0=A; c0!= c0_endp; c0+=C_sbs_stride,a0+=A_sbs_stride) {
      ...
      if (n_marg_el & 0x8) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4,ap0_1+=4) {
            mul_mf2x4mf4x8_mf2x8(c00,c01,c02,c03,c04,c05,c06,c07,c10,c11,c12,c13,c14,c15,c16,c17,ap0_0,ap0_1,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
            mul_mf2x2mf2x8_mf2x8(c00,c01,c02,c03,c04,c05,c06,c07,c10,c11,c12,c13,c14,c15,c16,c17,ap0_0,ap0_1,bp0,Bstride);
            ap0_0+=2;ap0_1+=2;
         }
         if (k_marg_el & 0x1) {
            mul_mf2x1mf1x8_mf2x8(c00,c01,c02,c03,c04,c05,c06,c07,c10,c11,c12,c13,c14,c15,c16,c17,ap0_0,ap0_1,bp0,Bstride);
         }
      ...
      if (n_marg_el & 0x4) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4,ap0_1+=4) {
            mul_mf2x4mf4x4_mf2x4(c00,c01,c02,c03,c10,c11,c12,c13,ap0_0,ap0_1,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
            mul_mf2x2mf2x4_mf2x4(c00,c01,c02,c03,c10,c11,c12,c13,ap0_0,ap0_1,bp0,Bstride);
            ap0_0+=2;ap0_1+=2;
         }
         if (k_marg_el & 0x1) {
            mul_mf2x1mf1x4_mf2x4(c00,c01,c02,c03,c10,c11,c12,c13,ap0_0,ap0_1,bp0,Bstride);
         }
      ...
      if (n_marg_el & 0x2) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4,ap0_1+=4) {
            mul_mf2x4mf4x2_mf2x2(c00,c01,c10,c11,ap0_0,ap0_1,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
            mul_mf2x2mf2x2_mf2x2(c00,c01,c10,c11,ap0_0,ap0_1,bp0,Bstride);
            ap0_0+=2;ap0_1+=2;
         }
         if (k_marg_el & 0x1) {
            mul_mf2x1mf1x2_mf2x2(c00,c01,c10,c11,ap0_0,ap0_1,bp0,Bstride);
         }
      ...
      if (n_marg_el & 0x1) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4,ap0_1+=4) {
            mul_mf2x4mf4x1_mf2x1(c00,c10,ap0_0,ap0_1,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
            mul_mf2x2mf2x1_mf2x1(c00,c10,ap0_0,ap0_1,bp0,Bstride);
            ap0_0+=2;ap0_1+=2;
         }
         if (k_marg_el & 0x1) {
            mul_mf2x1mf1x1_mf2x1(c00,c10,ap0_0,ap0_1,bp0,Bstride);
         }
   ...
   if (m_marg_el & 0x1) {
      ...
      for (b0=B,cp0=c0; cp0!=cp0_endp; b0+=10,cp0+=10) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4) {
            mul_mf1x4mf4x10_mf1x10(c00,c01,c02,c03,c04,c05,c06,c07,c08,c09,ap0_0,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
      ...
      if (n_marg_el & 0x8) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4) {
            mul_mf1x4mf4x8_mf1x8(c00,c01,c02,c03,c04,c05,c06,c07,ap0_0,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
      ...
      if (n_marg_el & 0x4) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4) {
            mul_mf1x4mf4x4_mf1x4(c00,c01,c02,c03,ap0_0,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
      ...
      if (n_marg_el & 0x2) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4) {
            mul_mf1x4mf4x2_mf1x2(c00,c01,ap0_0,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
      ...
      if (n_marg_el & 0x1) {
         ...
         for (; ap0_0!=ap0_endp; ap0_0+=4) {
            mul_mf1x4mf4x1_mf1x1(c00,ap0_0,bp0,Bstride);
         }
         if (k_marg_el & 0x2) {
...
void
_php_mulacc_mfmf_mf_l1(const float *const A, const float *const B, float *const C, const int Astride, const int Bstride, const int Cstride)
{
   const float *a0,*b0;
   float *c0;
   const float *ap0_0,*ap0_1;
...
void
qn_pp_mulacc_mfmf_mf_sss(const int M, const int K, const int N, const float *const A, const float *const B, float *const C, const int Astride, const int Bstride, const int Cstride)
{
   ...
   float *cp2;
   if (M < 53 && K < 53 && N < 51) {
      _php_mulacc_mfmf_mf_l1_arb_all(M,K,N,A,B,C,Astride,Bstride,Cstride);
      return;
   }
   for (m2=0; m2<=M-52; m2+=52) {
      ...
      for (n2=0,b2=B,cp2=c2; n2<=N-50; n2+=50,b2+=50,cp2+=50) {
         for (k2=0,bp2=b2,ap2=a2; k2<=K-52; k2+=52,bp2+=52*Bstride,ap2+=52) {
            _php_mulacc_mfmf_mf_l1(ap2,bp2,cp2,Astride,Bstride,Cstride);
         }
         if (k2 < K) {
            _php_mulacc_mfmf_mf_l1_arb_k(K-k2,ap2,bp2,cp2,Astride,Bstride,Cstride);
         }
      }
      if (n2 < N) {
         for (k2=0,bp2=b2,ap2=a2; k2<=K-52; k2+=52,bp2+=52*Bstride,ap2+=52) {
            _php_mulacc_mfmf_mf_l1_arb_all(52,52,N-n2,ap2,bp2,cp2,Astride,Bstride,Cstride);
         }
         if (k2 < K) {
            _php_mulacc_mfmf_mf_l1_arb_all(52,K-k2,N-n2,ap2,bp2,cp2,Astride,Bstride,Cstride);
         }
      }
   }
   if (m2 < M) {
      ...
      for (n2=0,b2=B,cp2=c2; n2<=N-50; n2+=50,b2+=50,cp2+=50) {
         for (k2=0,bp2=b2,ap2=a2; k2<=K-52; k2+=52,bp2+=52*Bstride,ap2+=52) {
            _php_mulacc_mfmf_mf_l1_arb_all(M-m2,52,50,ap2,bp2,cp2,Astride,Bstride,Cstride);
         }
         if (k2 < K) {
            _php_mulacc_mfmf_mf_l1_arb_all(M-m2,K-k2,50,ap2,bp2,cp2,Astride,Bstride,Cstride);
         }
      }
      if (n2 < N) {
         for (k2=0,bp2=b2,ap2=a2; k2<=K-52; k2+=52,bp2+=52*Bstride,ap2+=52) {
            _php_mulacc_mfmf_mf_l1_arb_all(M-m2,52,N-n2,ap2,bp2,cp2,Astride,Bstride,Cstride);
         }
         if (k2 < K) {
            _php_mulacc_mfmf_mf_l1_arb_all(M-m2,K-k2,N-n2,ap2,bp2,cp2,Astride,Bstride,Cstride);
         }
      }
   }
}
